...
namespace Proyecto_Clinic_Veterinaria.DAL
{
    public class UnitOfWork:IDisposable
    {
        ...
        public RepositorioAvisosCita RepositorioAvisosCita
        {
            get
            {
                if (this.repositorioAvisosCita == null)
                {
                    this.repositorioAvisosCita =
                        new RepositorioAvisosCita(context);
                }

                return repositorioAvisosCita;
            }
        }

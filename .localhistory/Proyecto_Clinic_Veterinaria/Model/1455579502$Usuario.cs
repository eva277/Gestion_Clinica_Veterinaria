...
namespace Proyecto_Clinic_Veterinaria.Model
{
    public class Usuario
    {
        ...
        public virtual ICollection<Cliente> ListaMascota { get; set; }
        ...
        public Usuario()
        {
            ...
            ListaMascota = new Collection<Cliente>();
            ListaAvisosAtencion = new Collection<AvisosAtencion>();
            ListaTipoAtencion = new Collection<Cliente>();
            ListaRegistrosAtencion = new Collection<RegistrosAtencion>();
            ListaJaula = new Collection<Cliente>();

    ...
    public partial class FirstMigration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        AvisosCitaId = c.Int(nullable: false, identity: true),
            ...
            CreateTable(
                ...
                c => new
                    {
                        RegistrosCitasId = c.Int(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.RegistrosCitasId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.RegistrosCitas", "UsuarioId", "dbo.Usuarios");
            DropForeignKey("dbo.TipoCitas", "UsuarioId", "dbo.Usuarios");
            DropForeignKey("dbo.RegistrosCitas", "TipoAtencion_TipoCitaID", "dbo.TipoCitas");
            DropForeignKey("dbo.AvisosCitas", "TipoCitaID", "dbo.TipoCitas");
            ...
            DropForeignKey("dbo.AvisosCitas", "UsuarioId", "dbo.Usuarios");
            DropForeignKey("dbo.RegistroHotel_Hospital", "JaulaId", "dbo.Jaulas");
            DropForeignKey("dbo.AvisosCitas", "MascotaId", "dbo.Mascotas");
            DropForeignKey("dbo.Mascotas", "ClienteId", "dbo.Clientes");
            DropIndex("dbo.TipoCitas", new[] { "UsuarioId" });
            DropIndex("dbo.RegistrosCitas", new[] { "TipoAtencion_TipoCitaID" });
            DropIndex("dbo.RegistrosCitas", new[] { "UsuarioId" });
            ...
            DropIndex("dbo.AvisosCitas", new[] { "UsuarioId" });
            DropIndex("dbo.AvisosCitas", new[] { "TipoCitaID" });
            DropIndex("dbo.AvisosCitas", new[] { "MascotaId" });
            DropTable("dbo.TipoCitas");
            DropTable("dbo.RegistrosCitas");
            DropTable("dbo.Usuarios");
            DropTable("dbo.Jaulas");
            DropTable("dbo.RegistroHotel_Hospital");
            DropTable("dbo.Clientes");
            DropTable("dbo.Mascotas");
            DropTable("dbo.AvisosCitas");
        }
    }
}

...
namespace Proyecto_Clinic_Veterinaria.DAL
{
    public class UnitOfWork:IDisposable
    {
        ...
        private RepositorioTipoAtencion repositorioTipoAtencion;
        ...
        public RepositorioTipoAtencion RepositorioTipoCitas
        {
            get
            {
                if (this.repositorioTipoAtencion == null)
                {
                    this.repositorioTipoAtencion =
                        new RepositorioTipoAtencion(context);
                }

                return repositorioTipoAtencion;
            }
        }
